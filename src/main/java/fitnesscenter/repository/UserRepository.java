...
public class UserRepository implements IUserRepository {
	...
	public void save(User user) {
		...
		db.update(sql, user.getId(),user.getPhoneNumber(),user.getAddress(),user.getFirstName(),user.getLastName(),user.getPassword(),user.getEmail(),user.getCcNumber(),user.getMainLanguage().getId(),user.getRole().toString(),user.getTimezone().getID(),true);
